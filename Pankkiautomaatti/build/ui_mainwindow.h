...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMinimumSize(QSize(661, 425));
        MainWindow->setMaximumSize(QSize(661, 425));
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        btn_balance = new QPushButton(centralwidget);
        btn_balance->setObjectName(QString::fromUtf8("btn_balance"));
        btn_balance->setGeometry(QRect(10, 90, 150, 50));
        QFont font;
        ...
        btn_logOut->setGeometry(QRect(10, 330, 150, 50));
        ...
        btn_next10actions->setGeometry(QRect(500, 90, 150, 50));
        ...
        btn_credit->setGeometry(QRect(260, 30, 75, 51));
        ...
        label_cardMode->setGeometry(QRect(40, 30, 81, 51));
        label_cardMode->setFont(font);
        label_cardMode->setStyleSheet(QString::fromUtf8("color:rgb(85, 0, 255);\n"
"background-color: rgb(255, 255, 255);"));
        mainmenulogo = new QLabel(centralwidget);
        mainmenulogo->setObjectName(QString::fromUtf8("mainmenulogo"));
        mainmenulogo->setGeometry(QRect(410, 10, 231, 71));
