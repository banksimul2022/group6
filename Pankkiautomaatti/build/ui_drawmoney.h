...
public:
    ...
    void retranslateUi(QDialog *DrawMoney)
    {
        ...
        btn_customAmount->setText(QCoreApplication::translate("DrawMoney", "Muu summa", nullptr));
