...
const action = {
  ...
  transfer: function(parameters, callback) {
    ...
    [parameters.accSend, parameters.accRecv, parameters.amount], callback);
  },
  ...
  //SELECT * FROM account_action JOIN client ON client.id_client = account_action.id_client WHERE client.id_client = ? ORDER BY action_time DESC limit 10;
